        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolarAccessToken = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: false),
                    Server = table.Column<string>(type: "varchar(32)", maxLength: 32, nullable: false),
                    WebhookEndpointId = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true),
                    WebhookSecret = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: false),
                    ...
                    DefaultPresentmentCurrency = table.Column<string>(type: "varchar(3)", maxLength: 3, nullable: true),
                    Status = table.Column<string>(type: "varchar(32)", maxLength: 32, nullable: false),
                    AccountId = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true),
                    PayoutAccountId = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true),
